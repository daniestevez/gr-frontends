...
# Title: WAV 48KHz file real time streamer (big-endian platform)
# Author: Daniel Estevez
# Description: Streams a WAV 48kHz file in real time
# Generated: Fri Aug 26 18:18:07 2016
##################################################
...
class wav_48kHz_realtime_be(gr.top_block):

    def __init__(self, input_file="", port=7355, destination="localhost"):
        gr.top_block.__init__(self, "WAV 48KHz file real time streamer (big-endian platform)")
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_endian_swap_0, 0), (self.blocks_throttle_0, 0))    
...
if __name__ == '__main__':
    ...
    tb = wav_48kHz_realtime_be(input_file=options.input_file, port=options.port, destination=options.destination)
    tb.start()
    tb.wait()
