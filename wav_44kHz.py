...
# Generated: Fri Aug 26 21:12:31 2016
##################################################
...
class wav_44kHz(gr.top_block):
    ...
    def __init__(self, input_file="", port=7355, destination="localhost"):
        ...
        # Blocks
        ##################################################
        self.rational_resampler_base_xxx_0 = filter.rational_resampler_base_fff(160, 147, (1, ))
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.rational_resampler_base_xxx_0, 0))    
        self.connect((self.rational_resampler_base_xxx_0, 0), (self.blocks_float_to_short_0, 0))    
...
if __name__ == '__main__':
    ...
    tb = wav_44kHz(input_file=options.input_file, port=options.port, destination=options.destination)
    tb.start()
    tb.wait()
