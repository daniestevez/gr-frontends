...
# Title: WAV 48KHz file fast streamer (little-endian platform)
# Author: Daniel Estevez
# Description: Streams a WAV 48kHz file fast (i.e., as fast as possible, not in real time)
# Generated: Fri Aug 26 18:18:05 2016
##################################################
...
class wav_48kHz_fast_le(gr.top_block):

    def __init__(self, input_file="", port=7355, destination="localhost"):
        gr.top_block.__init__(self, "WAV 48KHz file fast streamer (little-endian platform)")
...
if __name__ == '__main__':
    ...
    tb = wav_48kHz_fast_le(input_file=options.input_file, port=options.port, destination=options.destination)
    tb.start()
    tb.wait()
