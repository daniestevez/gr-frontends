...
# Title: SSB receiver for an Airspy device
# Author: Daniel Estevez
# Description: Receives with an Airspy and streams the USB audio (3kHz filter)
# Generated: Fri Sep 30 12:23:08 2016
##################################################
...
class airspy_usb(gr.top_block):

    def __init__(self, bb_gain=20, destination="localhost", freq=0, freq_corr=0, gpredict_port=4532, if_gain=40, offset=50e3, port=7355, rf_gain=40):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--if-gain", dest="if_gain", type="eng_float", default=eng_notation.num_to_str(40),
...
def main(top_block_cls=airspy_usb, options=None):
    if options is None:
